...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 837, ; uint32_t number_of_aot_cache_entries
	i32 100, ; uint32_t number_of_shared_libraries
	i32 u0x020002d0, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001cac, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001cab, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [837 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.49_name, ; name: libaot-Xamarin.AndroidX.SavedState.SavedState.Android.dll.so
		ptr null; void* handle
	}, ; 55
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x0f70a652f74002a7, ; from name: httpSpeed.dll.so
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
		ptr null; void* handle
	}, ; 60
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.ViewModelSavedState.Android.dll.so
		ptr null; void* handle
	}, ; 120
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Xamarin.AndroidX.Navigation.Common.Android.dll.so
		ptr null; void* handle
	}, ; 154
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.46_name, ; name: libaot-Xamarin.AndroidX.Navigation.Runtime.Android.dll.so
		ptr null; void* handle
	}, ; 186
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x434a1fea9b229e9c, ; from name: aot-httpSpeed
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x609417a61f056134, ; from name: httpSpeed.so
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x7181e9f9860e818b, ; from name: aot-httpSpeed.so
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x7c994d610f184a35, ; from name: httpSpeed
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x8c4eac0a444df220, ; from name: libaot-httpSpeed.dll.so
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x9a27b061b28f1379, ; from name: libaot-httpSpeed.so
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x9e2eb4d376220b04, ; from name: libaot-httpSpeed
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xd0f1b0f75a65720a, ; from name: aot-httpSpeed.dll.so
		i64 u0x8c4eac0a444df220, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-httpSpeed.dll.so
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.httpspeed\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [24 x i8] c"libaot-httpSpeed.dll.so\00", align 16
...
@.DSOCacheEntry.42_name = private unnamed_addr constant [69 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.ViewModelSavedState.Android.dll.so\00", align 16
@.DSOCacheEntry.43_name = private unnamed_addr constant [38 x i8] c"libaot-Xamarin.AndroidX.Loader.dll.so\00", align 16
@.DSOCacheEntry.44_name = private unnamed_addr constant [57 x i8] c"libaot-Xamarin.AndroidX.Navigation.Common.Android.dll.so\00", align 16
...
@.DSOCacheEntry.46_name = private unnamed_addr constant [58 x i8] c"libaot-Xamarin.AndroidX.Navigation.Runtime.Android.dll.so\00", align 16
...
@.DSOCacheEntry.49_name = private unnamed_addr constant [61 x i8] c"libaot-Xamarin.AndroidX.SavedState.SavedState.Android.dll.so\00", align 16
